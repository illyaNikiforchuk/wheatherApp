...
search.addEventListener("click", () => {
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/forecast?q=${city}&land=ua&units=metric&appid=49d7e42303a32fe7353bcf99def0e580`
  )
...
function HardCode(json) {
  btnTime1.addEventListener("click", () => {
    ...
    for (let i = 1; i <= 7; i++) {
      ...
      console.log("timeSpanDtTxt: ", timeSpanDtTxt);
      timeSpan.innerHTML = timeSpanDtTxt.toLocaleTimeString([], {
        day: "2-digit",
        month: "2-digit",
        hour: "2-digit",
        minute: "2-digit",
  ...
  btnTime2.addEventListener("click", () => {
    ...
    for (let i = 1; i <= json.list.length; i++) {
      ...
      timeSpan.innerHTML = timeSpanDtTxtt.toLocaleTimeString([], {
        day: "2-digit",
        month: "2-digit",
        hour: "2-digit",
        minute: "2-digit",
    ...
    //* creating btn after last timeUl
  });
}
...
function CreatingInfo(json) {
  ...
  time.innerHTML = mainTimeFromDttxt.toLocaleTimeString([], {
    day: "2-digit",
    month: "long",
    hour: "2-digit",
    minute: "2-digit",
